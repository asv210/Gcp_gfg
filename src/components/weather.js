...
const Weather = () => {
  ...
  return (
    <>
      <div style={{
        backgroundImage: `${bg}`, backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      }}>
        <center style={{ display: 'inline-flex' }}>
          <input type="text" name="" id="cityInput" placeholder='Enter city name' onChange={() => setCity(document.getElementById('cityInput').value)} />
        ...
        <center>
          <div className="icon">
            ...
            <div className="image"><p className='minValues' id='day1Min'>Current: {curr}°C</p></div>
            <p className='maxValues' id='day1Max'>Humidity: {humidity[0]}</p>
            <p className='maxValues' id='day1Max'>Wind: {wind[0]}</p>
